...
var testStory = (exportName, story, meta, skipTags) => async (context) => {
  let annotations = Vr(story, meta), composedStory = bi(annotations.story, annotations.meta, { initialGlobals: await (getInitialGlobals == null ? void 0 : getInitialGlobals()) ?? {} }, annotations.preview ?? globalThis.globalProjectAnnotations, exportName);
