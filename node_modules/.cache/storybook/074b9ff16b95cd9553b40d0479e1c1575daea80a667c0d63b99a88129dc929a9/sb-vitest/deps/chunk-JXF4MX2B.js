...
var require_memoizerific = __commonJS({ "../../node_modules/memoizerific/memoizerific.js"(exports, module) {
  (function(f2) {
    ...
    return function e2(t2, n2, r2) {
      ...
      for (var i22 = typeof __require == "function" && __require, o22 = 0; o22 < r2.length; o22++) s2(r2[o22]);
      return s2;
      ...
      function moveToMostRecentLru(lru, lruPath) {
        var lruLen = lru.length, lruPathLen = lruPath.length, isMatch, i22, ii;
        for (i22 = 0; i22 < lruLen; i22++) {
          for (isMatch = true, ii = 0; ii < lruPathLen; ii++) if (!isEqual(lru[i22][ii].arg, lruPath[ii].arg)) {
            isMatch = false;
            break;
          }
          if (isMatch) break;
...
function _construct(t2, e2, r2) {
  ...
  return r2 && _setPrototypeOf(p22, r2.prototype), p22;
}
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-KWX5PWTY.js");
...
var ve = xe(2);
function Ce(e2, t2) {
  let n2 = t2 === 1, i22 = n2 ? be : ve, l2 = n2 ? ye : ke, o22 = n2 ? he : me;
...
`).match(l2), c2 = false;
    return { items: a22.map(function(e4, n3) {
      let i4 = o22.exec(e4)[0].length, l3 = new RegExp("^ {1," + i4 + "}", "gm"), s2 = e4.replace(l3, "").replace(o22, ""), d2 = n3 === a22.length - 1, u2 = s2.indexOf(`

`) !== -1 || d2 && c2;
      c2 = u2;
      let p22 = r2.inline, f2 = r2.list, h22;
      r2.list = true, u2 ? (r2.inline = false, h22 = ze(s2) + `

`) : (r2.inline = true, h22 = ze(s2));
      let m2 = t3(h22, r2);
      return r2.inline = p22, r2.list = f2, m2;
    }), ordered: n2, start: i3 };
...
function Oe(e2, t2, n2, r2) {
  ...
  return e2.trim().split(/(`[^`]*`|\\\||\|)/).filter(Boolean).forEach((e3, t3, n3) => {
    e3.trim() === "|" && (a22(), r2) ? t3 !== 0 && t3 !== n3.length - 1 && l2.push([]) : o22 += e3;
...
`).map(function(e4) {
  ...
  return n2.inline = false, l2.length ? { align: i22, cells: l2, header: o22, type: r.table } : { children: o22, type: r.paragraph };
}
function Be(e2, t2) {
...
function _e(e2, t2, n2) {
  let r2 = n2.inline || false, i22 = n2.simple || false;
  n2.inline = true, n2.simple = true;
  let l2 = e2(t2, n2);
  return n2.inline = r2, n2.simple = i22, l2;
}
...
function Ve(e2, t2, n2) {
  let r2 = e2, i22 = t2.split(".");
  for (; i22.length && (r2 = r2[i22[0]], r2 !== void 0); ) i22.shift();
  return r2 || n2;
}
function Xe(n2 = "", i22 = {}) {
  function u2(e2, n3, ...r2) {
    let l2 = Ve(i22.overrides, `${e2}.props`, {});
    ...
    }(e2, i22.overrides), t({}, n3, l2, { className: Qe(n3 == null ? void 0 : n3.className, l2.className) || void 0 }), ...r2);
  }
  function Z22(e2) {
    e2 = e2.replace(w, "");
    let t2 = false;
...
`, { inline: t2 }));
  ...
  function q2(e2, t2) {
    ...
    return n3 ? n3.reduce(function(t3, n4) {
      ...
      if (r2 !== -1) {
        ...
        }(n4.slice(0, r2)).trim(), a22 = function(e3) {
          let t4 = e3[0];
          return (t4 === '"' || t4 === "'") && e3.length >= 2 && e3[e3.length - 1] === t4 ? e3.slice(1, -1) : e3;
        }(n4.slice(r2 + 1).trim()), s2 = l[o22] || o22;
        if (s2 === "ref") return t3;
  ...
  i22.overrides = i22.overrides || {}, i22.sanitizer = i22.sanitizer || He, i22.slugify = i22.slugify || Le, i22.namedCodesToUnicode = i22.namedCodesToUnicode ? t({}, o2, i22.namedCodesToUnicode) : o2, i22.createElement = i22.createElement || React20.createElement;
  let Q2 = [], V2 = {}, X2 = { [r.blockQuote]: { match: De(p2), order: 1, parse(e2, t2, n3) {
    let [, r2, i3] = e2[0].replace(f, "").match(h2);
    return { alert: r2, children: t2(i3, n3) };
  }, render(e2, t2, n3) {
    let l2 = { key: n3.key };
    return e2.alert && (l2.className = "markdown-alert-" + i22.slugify(e2.alert.toLowerCase(), Le), e2.children.unshift({ attrs: {}, children: [{ type: r.text, text: e2.alert }], noInnerParse: true, type: r.htmlBlock, tag: "header" })), u2("blockquote", l2, t2(e2.children, n3));
  } }, [r.breakLine]: { match: Ue(m), order: 1, parse: Ze, render: (e2, t2, n3) => u2("br", { key: n3.key }) }, [r.breakThematic]: { match: De(g), order: 1, parse: Ze, render: (e2, t2, n3) => u2("hr", { key: n3.key }) }, [r.codeBlock]: { match: De(k), order: 0, parse: (e2) => ({ lang: void 0, text: ze(e2[0].replace(/^ {4}/gm, "")).replace(ne, "$1") }), render: (e2, n3, r2) => u2("pre", { key: r2.key }, u2("code", t({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, [r.codeFenced]: { match: De(y), order: 0, parse: (e2) => ({ attrs: q2("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: r.codeBlock }) }, [r.codeInline]: { match: Ie(x2), order: 3, parse: (e2) => ({ text: e2[2].replace(ne, "$1") }), render: (e2, t2, n3) => u2("code", { key: n3.key }, e2.text) }, [r.footnote]: { match: De(C), order: 0, parse: (e2) => (Q2.push({ footnote: e2[2], identifier: e2[1] }), {}), render: qe }, [r.footnoteReference]: { match: Re($), order: 1, parse: (e2) => ({ target: `#${i22.slugify(e2[1], Le)}`, text: e2[1] }), render: (e2, t2, n3) => u2("a", { key: n3.key, href: i22.sanitizer(e2.target, "a", "href") }, u2("sup", { key: n3.key }, e2.text)) }, [r.gfmTask]: { match: Re(E), order: 1, parse: (e2) => ({ completed: e2[1].toLowerCase() === "x" }), render: (e2, t2, n3) => u2("input", { checked: e2.completed, key: n3.key, readOnly: true, type: "checkbox" }) }, [r.heading]: { match: De(i22.enforceAtxHeadings ? L : z3), order: 1, parse: (e2, t2, n3) => ({ children: _e(t2, e2[2], n3), id: i22.slugify(e2[2], Le), level: e2[1].length }), render: (e2, t2, n3) => u2(`h${e2.level}`, { id: e2.id, key: n3.key }, t2(e2.children, n3)) }, [r.headingSetext]: { match: De(A), order: 0, parse: (e2, t2, n3) => ({ children: _e(t2, e2[1], n3), level: e2[2] === "=" ? 1 : 2, type: r.heading }) }, [r.htmlBlock]: { match: Ue(O), order: 1, parse(e2, t2, n3) {
    let [, r2] = e2[3].match(le2), i3 = new RegExp(`^${r2}`, "gm"), l2 = e2[3].replace(i3, ""), o22 = (c2 = l2, Ee.some((e3) => e3.test(c2)) ? We : _e);
    var c2;
  ...
  }, render: (e2, n3, r2) => u2(e2.tag, t({}, e2.attrs, { key: r2.key })) }, [r.htmlComment]: { match: Ue(B), order: 1, parse: () => ({}), render: qe }, [r.image]: { match: Ie(Se), order: 1, parse: (e2) => ({ alt: e2[1], target: Pe(e2[2]), title: e2[3] }), render: (e2, t2, n3) => u2("img", { key: n3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: i22.sanitizer(e2.target, "img", "src") }) }, [r.link]: { match: Re($e), order: 3, parse: (e2, t2, n3) => ({ children: Fe(t2, e2[1], n3), target: Pe(e2[2]), title: e2[3] }), render: (e2, t2, n3) => u2("a", { key: n3.key, href: i22.sanitizer(e2.target, "a", "href"), title: e2.title }, t2(e2.children, n3)) }, [r.linkAngleBraceStyleDetector]: { match: Re(N2), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], type: r.link }) }, [r.linkBareUrlDetector]: { match: Me2((e2, t2) => t2.inAnchor || i22.disableAutoLink ? null : Re(D)(e2, t2)), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], title: void 0, type: r.link }) }, [r.linkMailtoDetector]: { match: Re(U), order: 0, parse(e2) {
    let t2 = e2[1], n3 = e2[1];
...
` }, [r.paragraph]: { match: Me2(Ne), order: 3, parse: Ge, render: (e2, t2, n3) => u2("p", { key: n3.key }, t2(e2.children, n3)) }, [r.ref]: { match: Re(P), order: 0, parse: (e2) => (V2[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: qe }, [r.refImage]: { match: Ie(_), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("img", { key: n3.key, alt: e2.alt, src: i22.sanitizer(V2[e2.ref].target, "img", "src"), title: V2[e2.ref].title }) : null }, [r.refLink]: { match: Re(F), order: 0, parse: (e2, t2, n3) => ({ children: t2(e2[1], n3), fallbackChildren: e2[0], ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("a", { key: n3.key, href: i22.sanitizer(V2[e2.ref].target, "a", "href"), title: V2[e2.ref].title }, t2(e2.children, n3)) : u2("span", { key: n3.key }, e2.fallbackChildren) }, [r.table]: { match: De(H), order: 1, parse: Te, render(e2, t2, n3) {
    let r2 = e2;
  ...
  } }, [r.text]: { match: Ue(re), order: 4, parse: (e2) => ({ text: e2[0].replace(T, (e3, t2) => i22.namedCodesToUnicode[t2] ? i22.namedCodesToUnicode[t2] : e3) }), render: (e2) => e2.text }, [r.textBolded]: { match: Ie(J2), order: 2, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => u2("strong", { key: n3.key }, t2(e2.children, n3)) }, [r.textEmphasized]: { match: Ie(K), order: 3, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => u2("em", { key: n3.key }, t2(e2.children, n3)) }, [r.textEscaped]: { match: Ie(te), order: 1, parse: (e2) => ({ text: e2[1], type: r.text }) }, [r.textMarked]: { match: Ie(Y2), order: 3, parse: Ge, render: (e2, t2, n3) => u2("mark", { key: n3.key }, t2(e2.children, n3)) }, [r.textStrikethroughed]: { match: Ie(ee), order: 3, parse: Ge, render: (e2, t2, n3) => u2("del", { key: n3.key }, t2(e2.children, n3)) } };
    ...
    function n3(r2, i3) {
      ...
      for (i3.prevCapture = i3.prevCapture || ""; r2; ) {
        ...
        for (; d2 < t2.length; ) {
          ...
          if (u3) {
            s2 = u3[0], i3.prevCapture += s2, r2 = r2.substring(s2.length), o22 = l2.parse(u3, n3, i3), o22.type == null && (o22.type = c2), a22.push(o22);
            break;
          }
          d2++;
        }
...
`).replace(S, "").replace(G, "    ");
  ...
  }(X2, i22.renderRule), function e2(t2, n3 = {}) {
    if (Array.isArray(t2)) {
  ...
  return Q2.length ? u2("div", null, se2, u2("footer", { key: "footer" }, Q2.map(function(e2) {
    return u2("div", { id: i22.slugify(e2.identifier, Le), key: e2.identifier }, e2.identifier, ae2(oe2(e2.footnote, { inline: true })));
  }))) : se2;
}
var index_modern_default = (t2) => {
  let { children: r2 = "", options: i22 } = t2, l2 = function(e2, t3) {
    if (e2 == null) return {};
    var n2, r3, i3 = {}, l3 = Object.keys(e2);
    for (r3 = 0; r3 < l3.length; r3++) t3.indexOf(n2 = l3[r3]) >= 0 || (i3[n2] = e2[n2]);
    return i3;
  }(t2, n);
  return React20.cloneElement(Xe(r2, i22), l2);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-HZN2XKGY.js"));
...
var sortFns = { alpha: (a22, b2) => (a22.name ?? "").localeCompare(b2.name ?? ""), requiredFirst: (a22, b2) => {
  var _a, _b;
  return +!!((_a = b2.type) == null ? void 0 : _a.required) - +!!((_b = a22.type) == null ? void 0 : _b.required) || (a22.name ?? "").localeCompare(b2.name ?? "");
}, none: null };
...
var Controls3 = (props) => {
  ...
  let mainComponentName = getComponentName(component) || "Story", subcomponentTabs = Object.fromEntries(Object.entries(subcomponents || {}).map(([key, comp]) => [key, { rows: Ct(extractComponentArgTypes2(comp, parameters), include, exclude), sort }])), tabs = { [mainComponentName]: { rows: filteredArgTypes, sort }, ...subcomponentTabs };
...
//# sourceMappingURL=chunk-JXF4MX2B.js.map
