...
var dt = Jr((fe, yt) => {
  (function(n, s) {
    ...
    let a = ne, oe2 = class oe3 extends Error {
      constructor(t) {
        super(`The parsing ended early. The next token was: ${s(t)}`), this.token = t, Object.setPrototypeOf(this, oe3.prototype);
      }
      getToken() {
        return this.token;
      }
    ...
    let p = oe2, se = class se2 extends Error {
      constructor(t, o) {
...
var Nr = r((n) => {
  switch (n.type) {
    ...
    default:
      throw new oe({ type: n, language: "Flow" });
  }
}, "convertSig");
var B = r((n) => {
  var _a, _b, _c, _d;
...
var Ar = r((n) => {
  switch (n.type) {
    ...
    default:
      throw new oe({ type: n, language: "Typescript" });
  }
}, "convertSig");
var M = r((n) => {
  var _a, _b, _c, _d;
...
//# sourceMappingURL=chunk-YQB4ENBK.js.map
